...
#[allow(dead_code)]
pub static RUSTC: &str = "/Users/jarospaw/.rustup/toolchains/stable-aarch64-apple-darwin/bin/rustc";
#[allow(clippy::needless_raw_string_hashes)]
#[doc=r#"The documentation generator that cargo resolved to use."#]
#[allow(dead_code)]
pub static RUSTDOC: &str = "/Users/jarospaw/.rustup/toolchains/stable-aarch64-apple-darwin/bin/rustdoc";
#[allow(clippy::needless_raw_string_hashes)]
...
#[allow(clippy::needless_raw_string_hashes)]
#[doc=r#"The output of `/Users/jarospaw/.rustup/toolchains/stable-aarch64-apple-darwin/bin/rustc -V`"#]
#[allow(dead_code)]
pub static RUSTC_VERSION: &str = "rustc 1.95.0 (59807616e 2026-04-14)";
#[allow(clippy::needless_raw_string_hashes)]
#[doc=r#"The output of `/Users/jarospaw/.rustup/toolchains/stable-aarch64-apple-darwin/bin/rustdoc -V`; empty string if `/Users/jarospaw/.rustup/toolchains/stable-aarch64-apple-darwin/bin/rustdoc -V` failed to execute"#]
#[allow(dead_code)]
